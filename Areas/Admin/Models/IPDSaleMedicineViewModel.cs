...
{
    public class IPDSaleMedicineViewModel
    {
        ...
        [JsonIgnore]
        public List<IPDMedicineModel> Medicines
        {
            get
            {
                return string.IsNullOrEmpty(MedicinesJson)
                    ? new List<IPDMedicineModel>()
                    : JsonConvert.DeserializeObject<List<IPDMedicineModel>>(MedicinesJson);
            }
            set
            {
        ...
        public List<IPDDropDownItem> Categories { get; set; } = new List<IPDDropDownItem>();
    }

    public class IPDMedicineModel
    {
